...
--build-arg DART_PROTOBUF_VERSION="${DART_PROTOBUF_VERSION:-"2.0.1"}" \
...
--build-arg RUST_PROTOBUF_VERSION="${RUST_PROTOBUF_VERSION:-"2.25.2"}" \
--build-arg RUST_VERSION="${RUST_VERSION:-"1.57.0"}" \

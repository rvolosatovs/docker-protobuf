...
--build-arg GO_VERSION="${GO_VERSION:-"1.13.8"}" \
--build-arg GRPC_GATEWAY_VERSION="${GRPC_GATEWAY_VERSION:-"1.13.0"}" \
--build-arg GRPC_JAVA_VERSION="${GRPC_JAVA_VERSION:-"1.27.1"}" \
--build-arg GRPC_RUST_VERSION="${GRPC_RUST_VERSION:-"0.6.2"}" \
--build-arg GRPC_SWIFT_VERSION="${GRPC_SWIFT_VERSION:-"0.10.0"}" \
--build-arg GRPC_VERSION="${GRPC_VERSION:-"1.27.2"}" \
...
--build-arg PROTOC_GEN_FIELDMASK_VERSION="${PROTOC_GEN_FIELDMASK_VERSION:-"0.4.0"}" \
...
--build-arg RUST_VERSION="${RUST_VERSION:-"1.41.0"}" \

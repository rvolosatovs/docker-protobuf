...
--build-arg GO_VERSION="${GO_VERSION:-"1.13.5"}" \
...
--build-arg PROTOC_GEN_FIELDMASK_VERSION="${PROTOC_GEN_FIELDMASK_VERSION:-"0.3.0"}" \
...
--build-arg RUST_PROTOBUF_VERSION="${RUST_PROTOBUF_VERSION:-"2.10.0"}" \

...
--build-arg GO_VERSION="${GO_VERSION:-"1.14.0"}" \
...
--build-arg GRPC_VERSION="${GRPC_VERSION:-"1.27.3"}" \
--build-arg GRPC_WEB_VERSION="${GRPC_WEB_VERSION:-"1.0.7"}" \
--build-arg PROTOBUF_C_VERSION="${PROTOBUF_C_VERSION:-"1.3.3"}" \
--build-arg PROTOC_GEN_DOC_VERSION="${PROTOC_GEN_DOC_VERSION:-"1.3.1-ttn"}" \
...
--build-arg RUST_PROTOBUF_VERSION="${RUST_PROTOBUF_VERSION:-"2.10.2"}" \
--build-arg RUST_VERSION="${RUST_VERSION:-"1.42.0"}" \

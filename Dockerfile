...
RUN make
RUN make plugins
RUN install -Ds /grpc-swift/protoc-gen-swift /protoc-gen-swift/protoc-gen-swift
RUN install -Ds /grpc-swift/protoc-gen-grpc-swift /protoc-gen-swift/protoc-gen-grpc-swift
RUN <<EOF
    case ${TARGETARCH} in

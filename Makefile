...
GRPC_SWIFT_VERSION ?= 0.10.0
GRPC_VERSION ?= 1.24.3
GRPC_WEB_VERSION ?= 1.0.6
PROTOBUF_C_VERSION ?= 1.3.2
PROTOC_GEN_DOC_VERSION ?= 1.3.0-ttn.2
PROTOC_GEN_FIELDMASK_VERSION ?= 0.2.2
PROTOC_GEN_GO_VERSION ?= 1.3.2
PROTOC_GEN_GOGO_VERSION ?= 1.3.1
PROTOC_GEN_GOGOTTN_VERSION ?= 3.0.14
